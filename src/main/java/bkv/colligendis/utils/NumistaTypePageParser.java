...
public class NumistaTypePageParser {
    ...
    public static Boolean parse(String nid) {
        ...
        System.out.println("Page loading" + " takes " + (System.currentTimeMillis() - timeMetricStartParsing) / 1000 + " sec " + (System.currentTimeMillis() - timeMetricStartParsing) % 1000 + " millis");
...
//        }
        ...
        if(changed){
            ...
            if (showTimeMetrics) {
                DebugUtil.showInfo(NumistaEditPageUtil.class, composeTimeInfo("nid: " + nType.getNid() + " Saving NType takes: ", time));
            }
        } else {
            DebugUtil.showInfo(NumistaEditPageUtil.class, "nid: " + nType.getNid() + "NType without saving.");
        }


        if (showTimeMetrics) {
            DebugUtil.showInfo(NumistaEditPageUtil.class, composeTimeInfo("nid: " + nType.getNid() + " Parsing totally takes: ", timeMetricStartParsing));
        }
