...
public class ItemRestService {
    ...
    public ResponseEntity<Item> getItemById(@PathVariable(name = "itemId") String itemId) {
        final Item item = serviceUtils.itemService.findByEid(itemId);
        return item != null
    ...
    public ResponseEntity<Item> getItemByNumistaNumber(@PathVariable(name = "numistaNumber") String numistaNumber) {
        final Item item = serviceUtils.itemService.findByNumistaNumber(numistaNumber);
        return item != null
                ? ResponseEntity.ok(item)
                : ResponseEntity.notFound().build();
    }
    ...
    public ResponseEntity<Item> loadItemFromNumista(@PathVariable(name = "numistaNumber") String numistaNumber) {
...
//        }
    ...
    @ResponseBody
    public ResponseEntity<Item> reloadItemProperties(@PathVariable(name = "itemId") long itemId) {
    ...
    public ResponseEntity<Boolean> changeItemType(@PathVariable(name = "itemId") long itemId, @PathVariable(name = "newItemType") String newItemType) {
    ...
    @GetMapping(value = "{nodeName}/property/set/{nodeId}/{propertyName}/{value}")
    public ResponseEntity<Boolean> changeItemType(@PathVariable(name = "nodeName") String nodeName, @PathVariable(name = "nodeId") String nodeId, @PathVariable(name = "propertyName") String propertyName,
        ...
        if (nodeName.equals("ITEM")) {
            Item item = serviceUtils.itemService.findByEid(nodeId);
            if (item != null) {
        ...
        } else if (nodeName.equals("TERRITORY")) {
            Territory territory = serviceUtils.territoryService.findByEid(nodeId);
            if (territory != null) {
                if (set(territory, propertyName, value)) {
                    return serviceUtils.territoryService.save(territory) != null ? ResponseEntity.ok(true)
                            : ResponseEntity.notFound().build();
                }

            }
        } else if (nodeName.equals("ISSUER")) {
            Issuer issuer = serviceUtils.issuerService.findByEid(nodeId);
            if (issuer != null) {
                if (set(issuer, propertyName, value)) {
                    return serviceUtils.issuerService.save(issuer) != null ? ResponseEntity.ok(true)
                            : ResponseEntity.notFound().build();
                }

            }
        } else if (nodeName.equals("COMM_ISSUE_SERIES")) {
            CommIssueSeries commIssueSeries = serviceUtils.commIssueSeriesService.findByEid(nodeId);
            if (commIssueSeries != null) {
                if (set(commIssueSeries, propertyName, value)) {
                    return serviceUtils.commIssueSeriesService.save(commIssueSeries) != null ? ResponseEntity.ok(true)
                            : ResponseEntity.notFound().build();
                }

            }
        } else if (nodeName.equals("PERIOD")) {
            Period period = serviceUtils.periodService.findByEid(nodeId);
            if (period != null) {
                if (set(period, propertyName, value)) {
                    return serviceUtils.periodService.save(period) != null ? ResponseEntity.ok(true)
                            : ResponseEntity.notFound().build();
                }

            }
        } else if (nodeName.equals("VALUE")) {
            Value val = serviceUtils.valueService.findByEid(nodeId);
            if (val != null) {
            ...
            Currency currency = serviceUtils.currencyService.findByEid(nodeId);
            if (currency != null) {
                if (set(currency, propertyName, value)) {
                    return serviceUtils.currencyService.save(currency) != null ? ResponseEntity.ok(true)
                            : ResponseEntity.notFound().build();
                }

            }
        } else if (nodeName.equals("ITEM_SIDE")) {
            ItemSide itemSide = serviceUtils.itemSideService.findByEid(nodeId);
            if (itemSide != null) {
                if (set(itemSide, propertyName, value)) {
                    return serviceUtils.itemSideService.save(itemSide) != null ? ResponseEntity.ok(true)
                            : ResponseEntity.notFound().build();
                }

            }
        } else if (nodeName.equals("MINT")) {
            Mint mint = serviceUtils.mintService.findByEid(nodeId);
            if (mint != null) {
    ...
    @ResponseBody
    public ResponseEntity<Set<Mint>> createNewMint(@PathVariable(name = "itemId") String itemId) {
        Item item = serviceUtils.itemService.findByEid(itemId);
        if (item != null) {
    ...
    @ResponseBody
    public ResponseEntity<Boolean> detachAndDeleteMint(@PathVariable(name = "itemId") String itemId, @PathVariable(name = "mintId") String mintId) {
        Item item = serviceUtils.itemService.findByEid(itemId);
        Mint mint = serviceUtils.mintService.findByEid(mintId);
    ...
    @ResponseBody
    public ResponseEntity<Boolean> detachMint(@PathVariable(name = "itemId") String itemId, @PathVariable(name = "mintId") String mintId) {
        Item item = serviceUtils.itemService.findByEid(itemId);
        Mint mint = serviceUtils.mintService.findByEid(mintId);
        if(item != null && mint != null){
            item.getMints().remove(mint);
    ...
    @ResponseBody
    public ResponseEntity<List<Mint>> getMintsWithNameFilter(@PathVariable(name = "nameFilter") String nameFilter) {
    ...
    @ResponseBody
    public ResponseEntity<Boolean> addMintToItem(@PathVariable(name = "itemId") String itemId, @PathVariable(name = "mintId") String mintId) {
        Item item = serviceUtils.itemService.findByEid(itemId);
        Mint mint = serviceUtils.mintService.findByEid(mintId);
...
//    }
    ...
    @ResponseBody
    public ResponseEntity<Set<SpecifiedMint>> createNewMark(@PathVariable(name = "itemId") String itemId) {
        Item item = serviceUtils.itemService.findByEid(itemId);
        if (item != null) {
...
//    @ResponseBody
//    public ResponseEntity<List<Mintmark>> getMarksWithNameFilter(@PathVariable(name = "nameFilter") String nameFilter) {
//        return ResponseEntity.ok(serviceUtils.markService.findByNameFilter(nameFilter));
//    }
//
//    @GetMapping(value = "/item/{itemId}/marks/add/{markId}")
//    @ResponseBody
//    public ResponseEntity<Boolean> addMarkToItem(@PathVariable(name = "itemId") Long itemId, @PathVariable(name = "markId") Long markId) {
//        Item item = serviceUtils.itemService.findById(itemId);
//        Mintmark mintmark = serviceUtils.markService.findById(markId);
//        if(item != null && mintmark != null && !item.getMarks().contains(mintmark)){
...
//    @ResponseBody
//    public ResponseEntity<Boolean> detachAndDeleteMark(@PathVariable(name = "itemId") Long itemId, @PathVariable(name = "markId") Long markId) {
//        Item item = serviceUtils.itemService.findById(itemId);
//        Mintmark mintmark = serviceUtils.markService.findById(markId);
...
//    @ResponseBody
//    public ResponseEntity<Boolean> detachMark(@PathVariable(name = "itemId") Long itemId, @PathVariable(name = "markId") Long markId) {
//        Item item = serviceUtils.itemService.findById(itemId);
//        Mintmark mintmark = serviceUtils.markService.findById(markId);
//        if(item != null && mintmark != null){
//            item.getMarks().remove(mintmark);
...
//
    ...
    @ResponseBody
    public ResponseEntity<Boolean> attachMintToVariant(@PathVariable(name = "variantId") String variantId, @PathVariable(name = "mintId") String mintId) {
    ...
    @ResponseBody
    public ResponseEntity<Boolean> detachMintFromVariant(@PathVariable(name = "variantId") String variantId) {
        Variant variant = serviceUtils.variantService.findByEid(variantId);
...
//    @ResponseBody
//    public ResponseEntity<Boolean> attachMarkToVariant(@PathVariable(name = "variantId") Long variantId, @PathVariable(name = "markId") Long markId) {
//        Variant variant = serviceUtils.variantService.findById(variantId);
//        Mintmark mintmark = serviceUtils.markService.findById(markId);
//
//        if(variant != null && mintmark != null && variant.getMintmark() != mintmark){
...
//    }
    ...
    @ResponseBody
    public ResponseEntity<Boolean> detachMarkFromVariant(@PathVariable(name = "variantId") String variantId) {
        Variant variant = serviceUtils.variantService.findByEid(variantId);
...
//        }
    ...
    public ResponseEntity<VariantDifference> saveVariantDifference(@RequestBody VariantDifference variantDifference) {
        return ResponseEntity.ok(serviceUtils.variantDifferenceService.save(variantDifference));
    }

    @GetMapping(value = "/variant/{variantId}/difference/new")
    @ResponseBody
    public ResponseEntity<VariantDifference> createNewVariantDifference(@PathVariable(name = "variantId") String variantId) {
        Variant variant = serviceUtils.variantService.findByEid(variantId);
...
//    @ResponseBody
//    public ResponseEntity<Boolean> deleteVariantDifference(@PathVariable(name = "variantId") long variantId) {
//        Variant variant = serviceUtils.variantService.findByEid(variantId);
//        if(variant != null && variant.getVariantDifference() != null){
...
//    public ResponseEntity<Resource> download(@PathVariable(name = "territory") Long territory) throws IOException {
//
//
