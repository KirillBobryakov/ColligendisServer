...
//    String findNidByEid(String eid);
    ...
    /**
     *  Check a relationship from a node with an uuid = {@code fromNodeUuid} to a node with an uuid = {@code toNodeUuid}. If there is not a relationship between nodes, create it with relationship's Type = {@code relationshipLabel}
     *
    ...
    /**
     *  Check has any relationship with type (@code relationshipType) from Entity with {@code fromNodeUuid} to any Entity
    ...
    /**
     * Get a property String value with a name = {@code propertyName} of the Entity with the uuid = {@code uuid}
     * @param uuid Entity's uuid
    ...
    /**
     * Set a property String {@code value} with a name = {@code propertyName} of the Entity with the uuid = {@code uuid}
     * @param uuid Entity's uuid
     * @param propertyName property's name
    ...
    /**
     * Get a property Boolean value with a name = {@code propertyName} of the Entity with the uuid = {@code uuid}
     * @param uuid Entity's uuid
     * @param propertyName property's name
    ...
    /**
     * Set a property Boolean {@code value} with a name = {@code propertyName} of the Entity with the uuid = {@code uuid}
     * @param uuid Entity's uuid
     * @param propertyName property's name
    ...
    void detachEntityFromAnotherEntityWithRelationshipType(String firstEntityUuid, String secondEntityUuid, String relationshipType);
